...
#
# This version plots the real-time integrated displacement signals
# produced by ewintegrate module. Helicorders only. PJS, 03-Dec-2014
#
use strict;
use CGI;
use CGI qw/:standard/;
...
my @stations;
my @stations_mon = qw( MBGH_HHZ_MV MBLY_HHZ_MV MBWH_HHZ_MV );
...
my $sta_default = 'MBGH_HHZ_MV';

# Spiders added 05-Jun-2014, PJS
#my @spiders;
#my @spiders_mon = qw( MSCP_SHZ_MV MSDE_SHZ_MV MSGL_SHZ_MV MSGS_SHZ_MV 
#					MSS1_SHZ_MV MSUH_SHZ_MV ) ;
# 
my @dates = ();
#my @whats = qw( heli sgram pan );
my @whats = qw( heli );

my $web_start_page = '/cgi-bin/seismic_plot_viewer_disp.cgi';
my $web_other_page = '/cgi-bin/seismic_plot_viewer_disp_2.cgi';
...
# Things for web page
my $title = join( ': ', $network, 'Helicorders for real-time integrated displacement channels' );
my $spaces = "&nbsp;";
