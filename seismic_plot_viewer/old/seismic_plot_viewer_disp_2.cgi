...
#
# This version, real-time integrated displacement channels. Helicorders only. PJS, 03-Dec-2014
use strict;
use CGI;
...
my $ext = 'gif';
my $layout;
my $web_start_page = '/cgi-bin/seismic_plot_viewer_disp_2.cgi';
my $web_other_page = '/cgi-bin/seismic_plot_viewer_disp.cgi';
my $web_wws_page = '/cgi-bin/wws_heli_viewer_disp.cgi';
my $plot_width = 500;
...
#} else {
	...
	$file_to_plot_1 = `heli_disp_nearest.pl $what_to_plot_1 $stat_to_plot_1 $date_to_plot`;
...
#	$file_to_plot_2 = glob($glob_str);
	$file_to_plot_2 = `heli_disp_nearest.pl $what_to_plot_2 $stat_to_plot_2 $date_to_plot_2`;
	# try to trim any whitespace
...
# Things for web page
my $title = join( ': ', $network, 'Real-time integrated displacement channels: Helicorders' );
my $space1 = "&nbsp;&nbsp;";
my $space2 = "&nbsp;&nbsp;&nbsp;&nbsp;";
my $space4 = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
...
print $space2, $space2, $space2;
print $q->a({href=>$web_wws_page},'Dynamic helicorders');
print "<BR>\n";
