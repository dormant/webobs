...
# modded for new codes, RCS 2020-12-07
#
use strict;
use CGI;
...
my %stations = ( 
    'MBBY' => { 'amp' => 5000,  'clip' => 30000, 'band' => 'HHZ', 'loc' => '00' }, # RCS 7-Dec-2020
    'MBFL' => { 'amp' => 5000,  'clip' => 30000, 'band' => 'HHZ', 'loc' => '00' }, # RCS 7-Dec-2020
    'MBFR' => { 'amp' => 1000, 'clip' => 20000 },
    'MBGB' => { 'amp' => 1000, 'clip' => 25000 },
    'MBGH' => { 'amp' => 5000, 'clip' => 30000, 'band' => 'HHZ', 'loc' => '00' }, # RCS 7-Dec-2020
    'MBHA' => { 'amp' => 100, 'clip' => 1000, 'band' => 'SHZ'}, # PJS 18-Dec-2013
    'MBLG' => { 'amp' => 6000, 'clip' => 40000 },
    'MBLY' => { 'amp' => 5000,  'clip' => 30000, 'band' => 'HHZ', 'loc' => '00' }, # RCS 7-Dec-2020
...
foreach my $nm (@subStationList)
{
    ...
    $stations{$alias}->{'loc'} = '--' unless exists $stations{$alias}->{'loc'};
    ...
    my $plot_nm = $alias.'_'.$stations{$alias}->{'band'}.'_'.$stations{$alias}->{'net'}.'_'.$stations{$alias}->{'loc'};
